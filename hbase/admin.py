...
class HBaseAdmin(object):
    ...
    def cluster_status(self):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/status/cluster"
        )

    def cluster_version(self):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/version/cluster"
        )

    def namespaces(self):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/namespaces"
        )

    def namespace(self, namespace_name):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/namespaces/{namespace_name}"
        )
    ...
    def tables(self, namespace='default'):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/namespaces/{namespace}/tables"
        )

    def table_regions(self, table_name):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/{table_name}/regions"
        )

    def table_schema(self, table_name):
        return self.client.send_request(
            method="GET",
            url_suffix=f"/{table_name}/schema"
        )
